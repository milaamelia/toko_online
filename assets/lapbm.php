...
$barang = mysqli_query($conn, "SELECT  s.no_faktur, s.tgl_masuk,b.nama_barang, r.nama_supplier, s.jumlah, s.harga   FROM tb_barangmasuk s JOIN tb_barang b ON s.kode_barang= b.kode_barang JOIN tb_supplier r ON s.kode_supplier = r.kode_supplier");
